...
public class JottTokenizerTester {
    ...
    private void createTestCases(){
        ...
        String filename = "phase1_tester/tokenizerTestCases/number.jott";
        ...
        String mathOps = "+-*/";
        filename = "phase1_tester/tokenizerTestCases/mathOpsTest.jott";
        ...
        filename = "phase1_tester/tokenizerTestCases/singleCharTokens.jott";
        ...
        filename = "phase1_tester/tokenizerTestCases/relOpsTokens.jott";
        ...
        filename = "phase1_tester/tokenizerTestCases/idKeywords.jott";
        ...
        filename = "phase1_tester/tokenizerTestCases/strings.jott";
        ...
        filename = "phase1_tester/tokenizerTestCases/errorTokens1.jott";
        testCases.add(new TestCase("ErrorTokens1", filename, null, true));

        filename = "phase1_tester/tokenizerTestCases/errorTokens2.jott";
        testCases.add(new TestCase("ErrorTokens2", filename, null, true));

        filename = "phase1_tester/tokenizerTestCases/errorTokens3.jott";
        testCases.add(new TestCase("ErrorTokens3", filename, null, true));

        filename = "phase1_tester/tokenizerTestCases/stringMissingClosing.jott";
        testCases.add(new TestCase("StringMissingClosing", filename, null, true));

        ArrayList<Token> phase1ExampleTokens = new ArrayList<>();
        filename = "phase1_tester/tokenizerTestCases/phase1Example.jott";
        ...
        filename = "phase1_tester/tokenizerTestCases/phase1ErrorExample.jott";
