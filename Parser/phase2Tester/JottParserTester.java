//package phase2Tester;
package Parser.phase2Tester;
/*
...
public class JottParserTester {
    ...
    private boolean parserTest(TestCase test, String orginalJottCode){
        try {
            ...
            try {
                FileWriter writer = new FileWriter("Parser/phase2Tester/parserTestCases/parserTestTemp.jott");
                if (jottCode == null) {
                    System.err.println("\tFailed Test: " + test.testName);
            ...
            ArrayList<Token> newTokens = JottTokenizer.tokenize("Parser/phase2Tester/parserTestCases/parserTestTemp.jott");
    ...
    private boolean runTest(TestCase test){
        ...
        try {
            orginalJottCode = new String(
                    Files.readAllBytes(Paths.get("Parser/phase2Tester/parserTestCases/" + test.fileName)));
        } catch (IOException e) {
            e.printStackTrace();
            return false;
        }
