 ...
 *
 * This expects the test cases to be in the directory phase1_tester/tokenizerTestCases in the
 * same directory as the tester is run.
 *
 * @author Scott C Johnson (scj@cs.rit.edu)
 */

package Tokenizer.phase1_tester;
import Tokenizer.*;
...
public class JottTokenizerTester {
    ...
    private void createTestCases(){
        ...
        String filename = "Tokenizer/phase1_tester/tokenizerTestCases/number.jott";
        ...
        String mathOps = "+-*/";
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/mathOpsTest.jott";
        ...
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/singleCharTokens.jott";
        ...
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/relOpsTokens.jott";
        ...
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/idKeywords.jott";
        ...
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/strings.jott";
        ...
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/errorTokens1.jott";
        testCases.add(new TestCase("ErrorTokens1", filename, null, true));

        filename = "Tokenizer/phase1_tester/tokenizerTestCases/errorTokens2.jott";
        testCases.add(new TestCase("ErrorTokens2", filename, null, true));

        filename = "Tokenizer/phase1_tester/tokenizerTestCases/errorTokens3.jott";
        testCases.add(new TestCase("ErrorTokens3", filename, null, true));

        filename = "Tokenizer/phase1_tester/tokenizerTestCases/stringMissingClosing.jott";
        testCases.add(new TestCase("StringMissingClosing", filename, null, true));

        ArrayList<Token> phase1ExampleTokens = new ArrayList<>();
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/phase1Example.jott";
        ...
        filename = "Tokenizer/phase1_tester/tokenizerTestCases/phase1ErrorExample.jott";
